...
**      Not Applicable
*/
#define CFE_MISSION_SB_CMD_TOPICID          4
#define CFE_MISSION_SB_SEND_HK_TOPICID      5
#define CFE_MISSION_SB_SUB_RPT_CTRL_TOPICID 6
...
**      Not Applicable
*/
#define CFE_MISSION_SB_HK_TLM_TOPICID      6
#define CFE_MISSION_SB_STATS_TLM_TOPICID   7
#define CFE_MISSION_SB_ALLSUBS_TLM_TOPICID 8
#define CFE_MISSION_SB_ONESUB_TLM_TOPICID  9
