...
**      Not Applicable
*/
#define CFE_MISSION_TBL_CMD_TOPICID     7
#define CFE_MISSION_TBL_SEND_HK_TOPICID 8
...
**      Not Applicable
*/
#define CFE_MISSION_TBL_HK_TLM_TOPICID  10
#define CFE_MISSION_TBL_REG_TLM_TOPICID 11
