...
**      Not Applicable
*/
#define CFE_MISSION_EVS_CMD_TOPICID     2
#define CFE_MISSION_EVS_SEND_HK_TOPICID 3
...
**      Not Applicable
*/
#define CFE_MISSION_EVS_HK_TLM_TOPICID          3
#define CFE_MISSION_EVS_LONG_EVENT_MSG_TOPICID  4
#define CFE_MISSION_EVS_SHORT_EVENT_MSG_TOPICID 5
