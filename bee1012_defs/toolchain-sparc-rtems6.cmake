...
set(RTEMS_BSP               "erc32") # revise later
...
# set(RTEMS_BSP_C_FLAGS       "-march=erc32 -mtune=erc32 -fno-common")
set(RTEMS_BSP_C_FLAGS       "-mcpu=v7 -msoft-float -fno-common")
...
SET(RTEMS_TOOLS_PREFIX "$ENV{HOME}/quick_start/rtems/${CMAKE_SYSTEM_VERSION}" CACHE PATH
...
# Set BSP link cmd
SET(RTEMS_BSP_LINKCMDS "${RTEMS_BSP_PREFIX}/sparc-rtems6/erc32/lib/linkcmds")
SET(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,-T${RTEMS_BSP_LINKCMDS}")

# Set the root path
SET(CMAKE_FIND_ROOT_PATH "$ENV{HOME}/quick_start/rtems/6/sparc-rtems6/erc32")
