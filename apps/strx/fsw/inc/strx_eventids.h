...
#ifndef STRX_EVENTIDS_H
#define STRX_EVENTIDS_H
...
STRX_RESET_INF_EID     ,
STRX_MID_ERR_EID       ,
STRX_CMD_LEN_ERR_EID   ,
STRX_PIPE_ERR_EID      ,
STRX_VALUE_INF_EID     ,
STRX_CR_PIPE_ERR_EID   ,
STRX_SUB_HK_ERR_EID    ,
STRX_SUB_BCN_ERR_EID   ,
STRX_SUB_CMD_ERR_EID   ,
STRX_TABLE_REG_ERR_EID ,
STRX_SET_BAUD_SUCCESS_EID,
STRX_SET_FREQ_SUCCESS_EID,
STRX_GET_BAUD_SUCCESS_EID,
STRX_GET_FREQ_SUCCESS_EID,
STRX_GNDWDT_ERR_EID             ,
STRX_REBOOT_ERR_EID             ,
...
STRX_RESET_APP_COUNTER_EID,
STRX_RESET_DEVICE_COUNTER_EID,
