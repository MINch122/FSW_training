...
#define STX_SEND_BCN_MID  CFE_PLATFORM_CMD_TOPICID_TO_MIDV(CFE_MISSION_STX_SEND_BCN_TOPICID)

#define STX_HK_TLM_MID  CFE_PLATFORM_TLM_TOPICID_TO_MIDV(CFE_MISSION_STX_HK_TLM_TOPICID)
#define STX_APP_RPT_TLM_MID  CFE_PLATFORM_TLM_TOPICID_TO_MIDV(CFE_MISSION_STX_APP_RPT_TLM_TOPICID)
#define STX_BCN_TLM_MID  CFE_PLATFORM_TLM_TOPICID_TO_MIDV(CFE_MISSION_STX_BCN_TLM_TOPICID)
