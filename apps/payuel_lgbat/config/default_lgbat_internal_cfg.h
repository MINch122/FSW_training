...
// Mission Duration: max 2 weeks per ICD
#define LGBAT_MAX_MISSION_DURATION_SEC   (14u * 24u * 3600u)   // 1,209,600 sec 

// BMS Power Supply Status values
...
// SOC sleep threshold: BMS sleeps when SOC < 10%
#define LGBAT_SOC_SLEEP_THRESHOLD_X100   1000   

// Data ID enum — matches ICD Data IDs 0x01~0x0C
typedef enum {
