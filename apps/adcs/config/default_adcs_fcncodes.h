...
#define	ADCS_GET_UNSOLICIT_TLM_MSG_SETUP_CC		83 // 228
#define ADCS_GET_UNSOLICIT_EVENT_MSG_SETUP_CC	84 // 233
#define ADCS_GET_EVENT_LOG_STATUS_RESPONSE_CC	85 // 235
