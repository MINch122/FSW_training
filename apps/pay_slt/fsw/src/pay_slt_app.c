...
CFE_Status_t SLT_IFB_Init(void)
{
    ...
    SLT_IFB_Data.I2c2Handle = CFE_SRL_ApiGetHandle(CFE_SRL_I2C2_HANDLE_INDEXER);
    if (SLT_IFB_Data.I2c2Handle == NULL)
    {
        CFE_EVS_SendEvent(SLT_IFB_INIT_INF_EID, CFE_EVS_EventType_ERROR, "PAY_SLT: Failed to get I2C2 handle");
