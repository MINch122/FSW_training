...
#ifndef PAYUEL_LGPM_H
#define PAYUEL_LGPM_H
...
typedef struct
{
    ...
    */
    ...
    CFE_TBL_Handle_t TblHandles[PAYUEL_LGPM_NUMBER_OF_TABLES];
} PAYUEL_LGPM_Data_t;

/*
** Global data structure
*/
extern PAYUEL_LGPM_Data_t PAYUEL_LGPM_Data;

/****************************************************************************/
/*
** Local function prototypes.
**
** Note: Except for the entry point (PAYUEL_LGPM_Main), these
