...
HS_AMTEntry_t HS_AppMon_Tbl[HS_MAX_MONITORED_APPS] = {
    ...
    /*   5 */ {"CI_LAB_APP", 0, 2, HS_AMT_ACT_NOACT},  /* Lab bring-up: disable autonomous app restart */
    /*   6 */ {"TO_LAB_APP", 0, 2, HS_AMT_ACT_NOACT},  /* Lab bring-up: disable autonomous app restart */
    /*   7 */ {"SCH_LAB_APP", 0, 2, HS_AMT_ACT_NOACT}, /* Lab bring-up: disable autonomous app restart */
