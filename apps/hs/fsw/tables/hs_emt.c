...
HS_EMTEntry_t HS_EventMon_Tbl[HS_MAX_MONITORED_EVENTS] = {
    ...
    /*   5 */ {"CI_LAB_APP", 0, 626, HS_EMT_ACT_NOACT}, /* Lab bring-up: disable autonomous recovery action */
    /*   6 */ {"ADCS", 0, 114, HS_EMT_ACT_NOACT},       /* Lab bring-up: disable EPS auto reboot path */
    /*   7 */ {"TO_LAB_APP", 0, 41, HS_EMT_ACT_NOACT},  /* Lab bring-up: disable autonomous recovery action */
