...
#ifndef UTRX_EVENTIDS_H
#define UTRX_EVENTIDS_H
...
typedef enum{
    ...
    UTRX_SET_BAUD_SUCCESS_EID,
    UTRX_SET_FREQ_SUCCESS_EID,
    UTRX_GET_BAUD_SUCCESS_EID,
    UTRX_GET_FREQ_SUCCESS_EID,
    UTRX_GNDWDT_ERR_EID             ,
    UTRX_REBOOT_ERR_EID             ,
    ...
    UTRX_RESET_APP_COUNTER_EID,
    UTRX_RESET_DEVICE_COUNTER_EID,
    UTRX_GETMSGID_ERR_EID
