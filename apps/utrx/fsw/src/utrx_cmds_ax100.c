...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_GNDWDT_CLEAR_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_REBOOT_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_RXCONF_SET_BAUD_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TXCONF_SET_BAUD_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_RXCONF_SET_FREQ_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TXCONF_SET_FREQ_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_SET_DEFAULT_BAUD_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_RPARAM_SAVE_1_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_RPARAM_SAVE_5_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_RPARAM_SAVE_ALL_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_CHECK_STATE_PING_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
// // void UTRX_AX100_GetStatusConfiguration(const UTRX_AX100_GetStatusConfigurationCmd_t *Msg){
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_RXCONF_GET_BAUD_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;

//     if (status == DEVICE_SUCCESS) {
//         memcpy(UTRX_APP_Data.RptPkt.Report.ReturnValue, &baud, sizeof(baud));
//         UTRX_APP_Data.RptPkt.Report.ReturnDataSize = sizeof(baud);
//     }
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_RXCONF_GET_GUARD_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;

//     if (status == DEVICE_SUCCESS) {
//         memcpy(UTRX_APP_Data.RptPkt.Report.ReturnValue, &val, sizeof(val));
//         UTRX_APP_Data.RptPkt.Report.ReturnDataSize = sizeof(val);
//     }
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_RXCONF_GET_FREQ_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TXCONF_GET_BAUD_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TXCONF_GET_FREQ_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
// /* --- TLM --- */
// /* 주의: 아래 세 개는 디바이스 함수 시그니처가 int16* 이었음 → 로컬 변수도 int16_t로 수정 */
...
//     int16_t val    = 0;                       /* was uint16 → int16_t 로 수정 */
//     int32_t status = UTRX_TLM_GetTempBrd(&val);

//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TLM_GET_TEMP_BRD_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TLM_GET_LAST_RSSI_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TLM_GET_LAST_RFERR_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TLM_GET_ACTIVE_CONF_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TLM_GET_BOOT_COUNT_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TLM_GET_BOOT_CAUSE_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TLM_GET_LAST_CONTACT_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TLM_GET_TOT_TX_BYTES_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
...
//     UTRX_APP_Data.RptPkt.Report.CommandCode = UTRX_TLM_GET_TOT_RX_BYTES_CC;
//     UTRX_APP_Data.RptPkt.Report.ReturnType  = CMD_RETCODE_TYPE_DRIVER;
//     UTRX_APP_Data.RptPkt.Report.ReturnCode  = status;
