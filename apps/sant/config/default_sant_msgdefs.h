...
/**
 * @file
 *   Specification for the SANT command and telemetry 
 *   message constant definitions.
 *
 *  For SANT this is only the function/command code definitions
 */
#ifndef SANT_MSGDEFS_H
#define SANT_MSGDEFS_H

#include "common_types.h"
#include "sant_fcncodes.h"
 ...
 */
typedef struct SANT_HkTlm_Payload {
    uint8_t RebootCount;
} SANT_HkTlm_Payload_t;


/**
 * Beacon Payload
 */
typedef struct SANT_BcnTlm_Payload {
    uint8 DeployStatus;
} SANT_BcnTlm_Payload_t;
