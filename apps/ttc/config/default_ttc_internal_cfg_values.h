...
/**
 * @file
 *   TTC Application Private Config Definitions
 *
 ...
 * dictionary tool.
 */
#ifndef DEFAULT_TTC_INTERNAL_CFG_H
#define DEFAULT_TTC_INTERNAL_CFG_H
...
#define DEFAULT_TTC_PLATFORM_MAX_CHUNK_SIZE 220
