...
#define DEFAULT_TTC_MISSION_CMD_TOPICID     0x80
#define TTC_MISSION_SEND_HK_TOPICID         TTC_MISSION_TIDVAL(SEND_HK)
#define DEFAULT_TTC_MISSION_SEND_HK_TOPICID 0x81
#define TTC_MISSION_HK_TLM_TOPICID          TTC_MISSION_TIDVAL(HK_TLM)
#define DEFAULT_TTC_MISSION_HK_TLM_TOPICID  0x80
#define TTC_MISSION_ONEHZ_WAKEUP_TOPICID      TTC_MISSION_TIDVAL(ONEHZ_WAKEUP)
#define DEFAULT_TTC_MISSION_ONEHZ_WAKEUP_TOPICID 0x82
#define TTC_MISSION_REPORT_TLM_TOPICID      TTC_MISSION_TIDVAL(REPORT_TLM)
#define DEFAULT_TTC_MISSION_REPORT_TLM_TOPICID 0x83
