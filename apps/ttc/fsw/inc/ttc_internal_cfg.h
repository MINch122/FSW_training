...
#define DEFAULT_TTC_PLATFORM_MAX_COMMAND_SIZE 157 /* Maximum size of a command in bytes */

#define TTC_PLATFORM_MAX_CHUNK_SIZE     TTC_PLATFORM_CFGVAL(MAX_CHUNK_SIZE)
#define DEFAULT_TTC_PLATFORM_MAX_CHUNK_SIZE 162 /* Maximum bytes per plumb-write chunk */
