...
**      Micros - 0 to 999999
*/
#define CFE_MISSION_TIME_EPOCH_YEAR   2025
#define CFE_MISSION_TIME_EPOCH_DAY    331
#define CFE_MISSION_TIME_EPOCH_HOUR   1
#define CFE_MISSION_TIME_EPOCH_MINUTE 54
