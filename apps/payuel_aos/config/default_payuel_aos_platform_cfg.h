 ...
 * @file
 *
 * PAYUEL_AOS Application Platform Configuration Header File
 *
 ...
 * dictionary tool.
 */
#ifndef PAYUEL_AOS_PLATFORM_CFG_H
#define PAYUEL_AOS_PLATFORM_CFG_H

#include "payuel_aos_mission_cfg.h"
#include "payuel_aos_internal_cfg.h"
