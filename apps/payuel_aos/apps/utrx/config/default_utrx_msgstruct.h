 ...
 */
#ifndef UTRX_MSGSTRUCT_H
#define UTRX_MSGSTRUCT_H
...
//     UTRX_HkTlm_Payload_t Payload;         /**< \brief Telemetry payload */
// } UTRX_HkTlm_t;
...
} UTRX_ResetAppCmdCountersCmd_t;

typedef struct
{
    CFE_MSG_CommandHeader_t CommandHeader;
} UTRX_ResetDeviceCmdCountersCmd_t;
