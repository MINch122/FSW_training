...
/* Maximum chunk response size (header 5B + valid data up to 247B + CRC32 4B) */
#define PAYUEL_OBC_CHUNK_RESPONSE_SIZE 256   /**< 0x45/0x55 max chunk response size via CSP CAN */
